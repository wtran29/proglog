...
import (
	...
	"github.com/wtran29/proglog/internal/agent"
...
func TestAgent(t *testing.T) {
	// defines the config of the cert that is served to clients
	...
	// defines the config of the cert that is served between servers so they can
	// connect with and replicate each other
	...
	// similar as testProduceConsume() in server_test.go that checks we can produce to and
	// consume from a single node
