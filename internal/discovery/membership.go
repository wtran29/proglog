...
// setupSerf is used to setup Serf to discover services
...
// Handler represents some component within the service that needs
// to know when a server joins or leaves cluster
